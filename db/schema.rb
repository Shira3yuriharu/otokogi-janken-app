...
ActiveRecord::Schema.define(version: 2021_04_09_141355) do
  ...
  create_table "travel_selects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["travel_id"], name: "index_travel_selects_on_travel_id"
    t.index ["user_id"], name: "index_travel_selects_on_user_id"
  end
  ...
  create_table "travels", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["group_id"], name: "index_travels_on_group_id"
  end
